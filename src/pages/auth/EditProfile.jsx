...
const EditProfile = () => {
  ...
  const defaultAvatar = 'assets/images/avatar/avatar.png';
  const avatar = profileImage ? URL.createObjectURL(profileImage) : defaultAvatar;
...
const handleProfileImageRemove = () => {
    ...
    document.getElementById('uploadfile-1-preview').src = defaultAvatar;
};
  ...
  const handleSubmit = (event) => {
    ...
    // Create a new profile object with the updated values
    ...
    // Perform any other necessary actions, such as saving the updated profile to the server
    // ...

    // Navigate to the desired page (e.g., profile page)
    navigate('/profile');
  };
  ...
  {/* Mirrored from eduport.webestica.com/instructor-edit-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Feb 2025 10:26:39 GMT */}
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      >
                        ...
                        <span className="avatar avatar-xl">
                            ...
                            className="avatar-img rounded-circle border border-white border-3 shadow"
                            src={profileImage ? URL.createObjectURL(profileImage) : "assets/images/avatar/07.jpg"}
                            alt=""
                            />
                        </span>
                        {/* Remove btn */}
                        <button type="button" className="uploadremove" onClick={handlePRofileImageRemove}>
                ...
                <div className="card bg-transparent border rounded-3">
                  ...
                  <div className="card-body pb-0">
                    ...
                    <div className="mb-4 d-sm-flex border p-3 rounded">
                      {/* Title and content */}
                      <h2 className="fs-1 mb-0 me-3">
                        <i className="fab fa-github text-github" />
                      </h2>
                      <div>
                        <h6 className="mb-1">GitHub</h6>
                        <p className="mb-1 small">
                          Connect with GitHub account for a personalized
                          experience
                        </p>
                        {/* Button */}
                        <button
